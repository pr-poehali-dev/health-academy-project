        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-5">
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 flex-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["215", "221", "227", "224"].map((num) => (
                    <div key={num} className="bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-100 rounded-2xl p-4 text-center">
                      <div className="font-display text-4xl font-bold gradient-text">{num}</div>
              ...
              <div className="gradient-primary rounded-3xl p-6 text-white flex items-center gap-4">
                <div className="text-4xl">✨</div>
                <div>
                  <div className="font-bold text-lg mb-1">Обучение бесплатное</div>
                  <div className="text-white/75 text-sm">Все программы доступны пациентам поликлиники без дополнительной оплаты</div>
                </div>
              </div>
            </div>
          </div>
